...
import Modelo.vo.vo.Encriptacion_Desencriptacion;
...
public class GUI_Registro extends javax.swing.JFrame {
    ...
    public int ConsultarUserIngresado(int ID) throws ClassNotFoundException, SQLException {
        ArrayList<UsuarioVO> lista = manejadorBL.consultarUserIngresado(ID);
        int iduser = 0;
        for (UsuarioVO actual : lista) {
            iduser = actual.getID();
        }
        return iduser;
    }
    ...
    public int ConsultarIdRol() throws ClassNotFoundException, SQLException {
        ArrayList<RolVO> lista = manejadorBL2.consultarId_AIngresar();
        int idrol = 0;
        for (RolVO actual : lista) {
            idrol = actual.getIde();
        }
        return idrol;
    }
    ...
    public void InsertarUsuario() throws SQLException, ClassNotFoundException {
        ...
        UsuarioVO user = new UsuarioVO(name, apellido, userna, passWord, ident);
